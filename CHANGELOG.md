...
- Add Exponential Moving Average (EMA) callback for model weight averaging via `--ema_decay` CLI argument [\#338](https://github.com/mllam/neural-lam/pull/338) @abhaygoudannavar
